...
void testApp::setup() {
	...
	e->sphinxmodel_lm = "../sphinxmodel/voxforge_en_sphinx.lm.DMP";

	// set the path of the dict and the filler dict
	e->sphinxmodel_dict = "dictionary";
	e->sphinxmodel_fdict = "fillerdict";
#else
	e->sphinxmodel_am = "../sphinxmodel/cmudict_8gau";
	e->sphinxmodel_lm = "../sphinxmodel/voxforge_en_sphinx.lm.DMP";
	e->sphinxmodel_dict = "../sphinxmodel/cmudict.0.7a";
	e->sphinxmodel_fdict = "../sphinxmodel/noisedict";
#endif
